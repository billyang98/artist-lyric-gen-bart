...
#SBATCH -J artist-gen-bart-fullish-a9             # Job name
#SBATCH -o /work/05347/billyang/artist-lyric-gen-bart/out_dir/%j-fullish-a9.out       # Specify stdout output file (%j expands to jobId)
...
# max length <= 160
python bart.py --training_file support_files/lyrics_tagged_ablation_9_noised.csv  --model_name bart_fullish_a9 --max_length 160
