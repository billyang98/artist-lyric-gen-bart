...
#SBATCH -J artist-gen-bart-natural-a10            # Job name
#SBATCH -o /work/05347/billyang/artist-lyric-gen-bart/out_dir/%j-natural-a10.out       # Specify stdout output file (%j expands to jobId)
...
# max length <= 160
python bart.py --training_file support_files/llyrics_natural_ablation_10_noised_no_SL.csv  --model_name bart_natural-a10 --max_length 160
