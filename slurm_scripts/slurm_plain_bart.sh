...
#SBATCH -J artist-gen-plain_bart             # Job name
#SBATCH -o /work/05347/billyang/artist-lyric-gen-bart/out_dir/%j-plain_bart.out       # Specify stdout output file (%j expands to jobId)
...
# max length <= 160
python bart.py --training_file support_files/lyrics_no_persona.csv  --model_name bart_no_persona --max_length 100
