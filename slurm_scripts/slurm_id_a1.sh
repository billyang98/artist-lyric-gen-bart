...
#SBATCH -J artist-gen-bart-id-a1             # Job name
#SBATCH -o /work/05347/billyang/artist-lyric-gen-bart/out_dir/%j-id-a1.out       # Specify stdout output file (%j expands to jobId)
...
# max length <= 160
python bart.py --training_file support_files/lyrics_simple_ablation_1_noSL.csv  --model_name bart_id_a1 --max_length 102
