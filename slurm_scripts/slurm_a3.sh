...
#SBATCH -J artist-gen-bart-a3             # Job name
#SBATCH -o /work/05347/billyang/artist-lyric-gen-bart/out_dir/%j-a3.out       # Specify stdout output file (%j expands to jobId)
...
# max length <= 160
python bart.py --training_file support_files/lyrics_tagged_ablation_3_noised.csv  --model_name bart_a3 --max_length 160
