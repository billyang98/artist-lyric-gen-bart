...
#SBATCH -J artist-gen-bart-album-a2             # Job name
#SBATCH -o /work/05347/billyang/artist-lyric-gen-bart/out_dir/%j-album-a2.out       # Specify stdout output file (%j expands to jobId)
...
# max length <= 160
python bart.py --training_file support_files/lyrics_tagged_ablation_2_noised_noSL.csv  --model_name bart_album_a2 --max_length 160
